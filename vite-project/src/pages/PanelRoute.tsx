...
import StudentBookListPage from "@/app/dashboard/books/index.tsx";
import TeacherBookListPage from "@/app/teacher-dashboard/books/index.tsx";
import TeacherBookDetailPage from "@/app/teacher-dashboard/books/[id].tsx";
import TeacherBookEditPage from "@/app/teacher-dashboard/books/edit.tsx";
import TeacherBookCreatePage from "@/app/teacher-dashboard/books/create.tsx";
...
import TestsList from "@/app/teacher-dashboard/tests";
    ...
    return (
      <Routes>
        <Route path="/" element={<StudentLayout />}>
          ...
          <Route
            path="/test-collections/:id"
            element={<TestCollectionDetail />}
          />
          <Route
      ...
      <Routes>
        <Route path="/" element={<TeacherLayout />}>
          ...
          <Route
            ...
            element={<SessionsDetailPage />}
          />
          <Route path="/profile" element={<TeacherProfilePage />} />
          <Route path="/calendar" element={<CalendarPage />} />
          <Route path="/files" element={<FilesPage />} />
          <Route path="/books" element={<TeacherBookListPage />} />
          <Route path="/books/:id" element={<TeacherBookDetailPage />} />
          ...
          <Route path="/test-collections" element={<TestCollectionList />} />
          <Route
            path="/test-collections/new"
            element={<TestCollectionForm />}
          />
          <Route
            path="/test-collections/:id"
            element={<TestCollectionDetail />}
          />
          <Route
            path="/test-collections/:id/edit"
            element={<TestCollectionForm />}
          />
          <Route
            path="/test-collections/:id/create-test"
            element={<CreateTestInCollection />}
          />
          <Route
            path="/test-collections/:id/tests/:testId/edit"
            element={<EditTestInCollection />}
          />
          <Route
            path="/test-collections/:id/progress"
            element={<StudentProgressList />}
          />
          <Route
            path="/test-collections/:id/statistics"
            element={<TestCollectionStatistics />}
          />
          ...
          <Route
            path="/topic-tests/create"
            element={
              <Navigate
                to="/panel/tests/create?type=topic_based&content=pdf"
                replace
              />
            }
          />
          <Route
            path="/topic-tests/:testId/edit"
            element={<CreateTopicTestPage />}
          />
          <Route path="/folders" element={<FolderManagerPage />} />
          {/* Question Tests Routes */}
          <Route path="/question-tests" element={<QuestionTestsPage />} />
          <Route
            path="/question-tests/create"
            element={
              <Navigate
                to="/panel/tests/create?type=practice&content=typed_question"
                replace
              />
            }
          />
          <Route
            path="/question-tests/:id"
            element={<QuestionTestDetailPage />}
          />
          <Route
            path="/question-tests/:id/edit"
            element={<CreateQuestionTestPage />}
          />
          <Route
            path="/question-tests/:id/poster"
            element={<TestPosterPage />}
          />
          <Route path="/question-tests/:id/results" element={<TestReport />} />
          <Route
            path="/question-tests/:id/leaderboard"
            element={<TopPerformersLeaderboard />}
          />
          ...
          <Route
            ...
            element={<QuestionCollectionsPage />}
          />
          <Route
            path="/question-collections/create"
            element={<CreateQuestionCollectionPage />}
          />
        </Route>
      </Routes>
    );
