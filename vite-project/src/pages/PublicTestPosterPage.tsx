...
export default function PublicTestPosterPage() {
  ...
  //     // First try to convert to seconds (if it's a simple number like "1800.0")
  //     const numericDuration = parseFloat(duration);
  //     if (!isNaN(numericDuration)) {
  //       const totalMinutes = Math.floor(numericDuration / 60);
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background relative">
      ...
      <div className="fixed inset-0 opacity-5 pointer-events-none overflow-hidden">
        ...
        >
          ...
          <use
            href="#questionMark1"
            transform="translate(45,67) rotate(12) scale(0.8)"
          />
          <use
            href="#questionMark2"
            transform="translate(156,23) rotate(-15) scale(1.2)"
          />
          <use
            href="#questionMark1"
            transform="translate(278,134) rotate(35) scale(0.6)"
          />
          <use
            href="#questionMark2"
            transform="translate(89,189) rotate(-8) scale(1.1)"
          />
          <use
            href="#questionMark1"
            transform="translate(234,245) rotate(22) scale(0.9)"
          />
          <use
            href="#questionMark2"
            transform="translate(367,76) rotate(-25) scale(0.7)"
          />
          <use
            href="#questionMark1"
            transform="translate(423,198) rotate(18) scale(1.3)"
          />
          <use
            href="#questionMark2"
            transform="translate(145,312) rotate(-12) scale(0.8)"
          />
          <use
            href="#questionMark1"
            transform="translate(312,289) rotate(8) scale(1.0)"
          />
          <use
            href="#questionMark2"
            transform="translate(478,167) rotate(-30) scale(0.9)"
          />
          <use
            href="#questionMark1"
            transform="translate(67,356) rotate(25) scale(0.7)"
          />
          <use
            href="#questionMark2"
            transform="translate(189,98) rotate(-5) scale(1.1)"
          />
          <use
            href="#questionMark1"
            transform="translate(345,45) rotate(40) scale(0.85)"
          />
          <use
            href="#questionMark2"
            transform="translate(512,234) rotate(-18) scale(0.75)"
          />
          <use
            href="#questionMark1"
            transform="translate(123,278) rotate(15) scale(1.05)"
          />
          <use
            href="#questionMark2"
            transform="translate(267,156) rotate(-22) scale(0.95)"
          />
          <use
            href="#questionMark1"
            transform="translate(398,89) rotate(6) scale(0.65)"
          />
          <use
            href="#questionMark2"
            transform="translate(456,345) rotate(-35) scale(1.15)"
          />
          <use
            href="#questionMark1"
            transform="translate(78,123) rotate(28) scale(0.9)"
          />
          <use
            href="#questionMark2"
            transform="translate(534,278) rotate(-10) scale(0.8)"
          />
        </svg>
      </div>

      {/* Action Buttons */}
      <div className="max-w-4xl mx-auto p-6 mb-6 flex items-center justify-between print:hidden">
        <Button
          variant="outline"
          onClick={() => navigate("/")}
      ...
      {/* Poster Card */}
      <div className="max-w-4xl mx-auto p-6" ref={posterRef}>
        <Card className="m-0 p-0 bg-background/95 backdrop-blur-sm border-2 border-border/50 shadow-2xl overflow-hidden print:shadow-none print:border-0">
            ...
            <div className="bg-gradient-to-r from-primary/45 via-primary/85 to-primary/70 text-primary-foreground p-3 text-center relative overflow-hidden">
              ...
              <div className="absolute inset-0 opacity-[0.08]">
                ...
                >
                  ...
                  <use
                    href="#headerQuestion"
                    transform="translate(23,15) rotate(12) scale(0.8)"
                  />
                  <use
                    href="#headerQuestion"
                    transform="translate(67,28) rotate(-8) scale(0.6)"
                  />
                  <use
                    href="#headerQuestion"
                    transform="translate(134,18) rotate(18) scale(0.7)"
                  />
                  <use
                    href="#headerQuestion"
                    transform="translate(178,35) rotate(-15) scale(0.9)"
                  />
                  <use
                    href="#headerQuestion"
                    transform="translate(45,55) rotate(22) scale(0.65)"
                  />
                  <use
                    href="#headerQuestion"
                    transform="translate(98,48) rotate(-5) scale(0.75)"
                  />
                  <use
                    href="#headerQuestion"
                    transform="translate(156,62) rotate(10) scale(0.85)"
                  />
                </svg>
              </div>
            ...
            <div className="mt-4 text-center mx-4">
              ...
              <div className="mx-auto mt-3 flex flex-col items-center">
                {test.folders && test.folders.length > 0 && (
                  <div className="text-center flex flex-wrap gap-2 text-sm text-muted-foreground mb-3">
                    {test.folders.map((folder) => (
                      <Badge variant={"secondary"} key={folder.id}>
                        {folder.name}
                      </Badge>
                    ))}
                  </div>
