...
import { ContentCreatorSidebar } from "@/components/content-creator-sidebar";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export const ContentCreatorLayout = () => {
  ...
  const generateBreadcrumb = () => {
    ...
    if (pathSegments.length === 1) {
      return (
        <BreadcrumbList>
          <BreadcrumbItem>
            <BreadcrumbPage>پنل تولید محتوا</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      );
    }
    ...
    return (
      <BreadcrumbList>
        <BreadcrumbItem>
          <BreadcrumbLink href="/panel">پنل تولید محتوا</BreadcrumbLink>
        </BreadcrumbItem>
        <BreadcrumbSeparator />
